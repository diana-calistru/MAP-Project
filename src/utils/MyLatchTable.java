...
public class MyLatchTable implements MyILatchTable {
    ...
    public void put(int key, int value) throws MyException {
        synchronized (this) {
            ...
            } else throw new MyException(String.format("Latch table already contains the key %d!", key));
        }
    }
    ...
    public int get(int key) throws MyException {
        synchronized (this) {
            ...
            } else throw new MyException(String.format("Latch table doesn't contain the key %d!", key));
        }
    }
