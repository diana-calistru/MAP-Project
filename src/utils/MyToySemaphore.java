...
public class MyToySemaphore implements MyIToySemaphoreTable {
    ...
    public void put(int key, Tuple<Integer, List<Integer>, Integer> value) throws MyException {
        synchronized (this) {
            ...
            } else throw new MyException(String.format("Toy semaphore table already contains the key %d!", key));
        }
    }
    ...
    public Tuple<Integer, List<Integer>, Integer> get(int key) throws MyException {
        synchronized (this) {
            ...
            } else throw new MyException(String.format("Toy semaphore table doesn't contain the key %d!", key));
        }
    }
    ...
    public void update(int key, Tuple<Integer, List<Integer>, Integer> value) throws MyException {
        synchronized (this) {
            ...
            } else throw new MyException(String.format("Toy semaphore table doesn't contain key %d!", key));
        }
    }
