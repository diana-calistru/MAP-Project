...
public class MySemaphoreTable implements MyISemaphoreTable {
    ...
    public void put(int key, Pair<Integer, List<Integer>> value) throws MyException {
        synchronized (this) {
            ...
            } else throw new MyException(String.format("Semaphore table already contains the key %d!", key));
        }
    }
    ...
    public Pair<Integer, List<Integer>> get(int key) throws MyException {
        synchronized (this) {
            ...
            } else throw new MyException(String.format("Semaphore table doesn't contain the key %d!", key));
        }
    }
    ...
    public void update(int key, Pair<Integer, List<Integer>> value) throws MyException {
        synchronized (this) {
            ...
            } else throw new MyException(String.format("Semaphore table doesn't contain key %d!", key));
        }
    }
