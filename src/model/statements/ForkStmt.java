...
public class ForkStmt implements IStmt {
    ...
    public PrgState execute(PrgState state) throws MyException, FileNotFoundException, IOException {
        ...
        PrgState forked = new PrgState(stack, state.getSymTable().deepcopy(), state.getOut(), argument, state.getFileTable(), state.getHeap(), state.getLatchTable());
        return forked;
    }
