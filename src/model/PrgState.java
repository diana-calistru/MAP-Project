...
public class PrgState {
    ...
    public PrgState(MyIStack<IStmt> stk, MyIDictionary<String, Value> symtbl, MyIList<Value> ot, IStmt prg, MyIDictionary<StringValue, BufferedReader> ftbl, MyIHeap<Value> hp, MyISemaphoreTable semTable) {
        exeStack = stk;
        symTable = symtbl;
        out = ot;
    ...
    public void setSemaphoreTable(MyISemaphoreTable semTable) { this.semaphoreTable = semTable; }
